...
WITH ordered_median AS (
  ...
  AND clean_title = 'Data Scientist'
)
SELECT
  clean_title,
...
AND job.clean_title = 'Data Scientist';
...
WITH skill_stats_pct_rank AS (
  ...
  WHERE jd.year = 2022
  AND jd.clean_title = 'Data Scientist' 
...
-- Top Skill Count for Data Scientist Positions --
...
-- =============================================================== --
-- CTE: 2022 SKILL STATS with MEDIAN SALARY and Percentile Ranking --
-- Top Percentage Rank for Data Scientist Positions --
...
-- Year: 2023 --
-- ========================================================================= --
-- COMPARISON: 2023 Yearly Salary VS Median Salary for Data Scientist Positions --
...
-- YEAR: 2024 --
-- ========================================================================= --
-- COMPARISON: 2024 Yearly Salary VS Median Salary for Data Scientist Positions --
...
-- Year: 2025 --
-- ========================================================================= --
-- COMPARISON: 2025 Yearly Salary VS Median Salary for Data Scientist Positions --
...
LIMIT 20;
-- ======================================================== ==
-- 2022: Post Counts and Data Anlyst Salaries by Website & Company --
-- (What It Shows: How often does a company use a website to post Data Scientist positions. 
...
ORDER BY
  total_posts DESC;
  -- ===================================================================== --
  -- 2023: Post Counts and Data Scientist Salaries by Website & Company --
SELECT
 year,
 website,
 company_name,
...
ORDER BY
  total_posts DESC;
    -- ===================================================================== --
  -- 2024: Post Counts and Data Scientist Salaries by Website & Company --
SELECT
 year,
 website,
 company_name,
...
ORDER BY
  total_posts DESC;
    -- ===================================================================== --
  -- 2025: Post Counts and Data Scientist Salaries by Website & Company --
SELECT
 year,
 website,
 company_name,
...
ORDER BY
  total_posts DESC;
-- ============================================================== --
-- 2022 Studying salary trends for Data Scientist -- 
-- Track Salary Differences Over Time --
-- (What This Does: Returns monthly average salary per company and website for Data Scientist.
...
-- =================================================================================== --
 -- 2023: Studying salary trends for Data Scientist --
 -- Track Salary Differences Over Time --
 WITH company_monthly AS (
  SELECT
   year,	
...
ORDER BY website, company_name, month_year;
-- =================================================================================== --
 -- 2024: Studying salary trends for Data Scientist --
 -- Track Salary Differences Over Time --
...
ORDER BY website, company_name, month_year;
-- =================================================================================== --
 -- 2025: Studying salary trends for Data Scientist --
 -- Track Salary Differences Over Time --
