DROP TABLE IF EXISTS `2025_job_data`;

CREATE TABLE `2025_job_data` (
...
-- Inserting 2025 data to table 2025_job_data --

INSERT INTO `2025_job_data`
  (`index`, `date`, `year`, `month`, `company_name`, `clean_title`,
   `seniority_level`, `location`, `employment_type`, `remote_work`,
   `job_skills`, `salary_avg`, `salary_min`, `salary_max`,
   `salary_hourly`, `salary_yearly`, `salary_standardized`, `website`)
SELECT
  `index`, `date`, `year`, `month`, `company_name`, `clean_title`,
  `seniority_level`, `location`, `employment_type`, `remote_work`,
  `job_skills`, `salary_avg`, `salary_min`, `salary_max`,
...
SELECT COUNT(*) FROM `2025_job_data`;
SELECT * FROM `2025_job_data` LIMIT 15;

-- checking the current structure
DESCRIBE `2025_job_data`;

-- Confirming table structure
SHOW CREATE TABLE `2025_job_data`;

ALTER TABLE `2025_job_data` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
-- ==================================================================================== --
