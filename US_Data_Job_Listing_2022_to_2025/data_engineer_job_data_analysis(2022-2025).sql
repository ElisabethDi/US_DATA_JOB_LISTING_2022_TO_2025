...
AND job.clean_title = 'Data Engineer';
...
WITH skill_stats_pct_rank AS (
  ...
  WHERE jd.year = 2022
  AND jd.clean_title = 'Data Engineer' 
...
-- Top Skill Count for Data Engineer Positions --
...
-- =============================================================== --
-- CTE: 2022 SKILL STATS with MEDIAN SALARY and Percentile Ranking --
-- Top Percentage Rank for Data Engineer Positions --
...
-- Year: 2023 --
-- ========================================================================= --
-- COMPARISON: 2023 Yearly Salary VS Median Salary for Data Engineer Positions --
...
-- YEAR: 2024 --
-- ========================================================================= --
-- COMPARISON: 2024 Yearly Salary VS Median Salary for Data Engineer Positions --
...
-- Year: 2025 --
-- ========================================================================= --
-- COMPARISON: 2025 Yearly Salary VS Median Salary for Data Engineer Positions --
...
-- (What It Shows: How often does a company use a website to post Data Engineer positions. 
...
ORDER BY
  total_posts DESC;
-- ============================================================================= --
-- 2022 Studying salary trends for Data Engineer 
-- Track Salary Differences Over Time --
-- (What This Does: Returns monthly average salary per company and website for Data Engineer.
...
-- =================================================================================== --
 -- 2023: Studying salary trends for Data Engineer --
 -- Track Salary Differences Over Time --
...
ORDER BY website, company_name, month_year;
-- =================================================================================== --
 -- 2024: Studying salary trends for Data Engineer --
 -- Track Salary Differences Over Time --
...
ORDER BY website, company_name, month_year;
-- =================================================================================== --
 -- 2025: Studying salary trends for Data Engineer --
 -- Track Salary Differences Over Time --
