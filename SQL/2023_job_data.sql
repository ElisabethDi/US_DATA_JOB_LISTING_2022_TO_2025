DROP TABLE IF EXISTS `2023_job_data`;

CREATE TABLE `2023_job_data`(
...
-- Inserting 2023 data to table 2023_job_data --

INSERT INTO `2023_job_data`
...
WHERE `year` = 2023;
-- ======================================================================== --
SELECT COUNT(*) FROM `2023_job_data`;
SELECT * FROM `2023_job_data` LIMIT 25;

-- Checking the current structure
DESCRIBE `2023_job_data`;

-- Confirming table structure
SHOW CREATE TABLE `2023_job_data`;

select *
from 2023_job_data;

ALTER TABLE `2023_job_data` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
-- =================================================================================== --
