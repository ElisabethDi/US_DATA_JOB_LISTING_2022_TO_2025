DROP TABLE IF EXISTS `2024_job_data`;

CREATE TABLE `2024_job_data`(
...
-- Inserting 2024 data to table 2024_job_data --

INSERT INTO `2024_job_data`
...
WHERE `year` = 2024;
-- ==================================================================== --
SELECT COUNT(*) FROM `2024_job_data`;
SELECT * FROM `2024_job_data` LIMIT 55;

-- checking the current structure
DESCRIBE `2024_job_data`;

-- Confirming table structure
SHOW CREATE TABLE `2024_job_data`;

ALTER TABLE `2024_job_data` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
-- ======================================================================================== --
